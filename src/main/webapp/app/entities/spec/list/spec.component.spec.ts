...
describe('Spec Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'spec', component: SpecComponent }]), HttpClientTestingModule, SpecComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to specService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSpecIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSpecIdentifier).toHaveBeenCalledWith(entity);
